    ...
    <section>
        <v-app-bar class="app-bar" app flat height="122" elevation="0" floating :color="dark ? 'primary' : ''">
            ...
            <v-list class="nav-wrapper" :dark="dark ? dark : light" :color="$route.name == 'index' || dark ? 'primary' : ''">
                ...
                <div class="mega-menu">
                    <v-menu offset-y v-for="(menu, i) in megaMenu" :close-on-content-click="false" :key="i" content-class="mega-menu-content">
                        ...
                        <v-list :color="dark ? 'primary' : 'white'" class="mega-menu-list" elevation="0">
                            <div class="right">
                                <v-menu offset-x left offset-overflow open-on-hover :close-on-content-click="false" content-class="sub-menu-content" v-for="(subMenu, k) in menu.subMenu" :key="k" :dark="dark ? dark : ''">
                                    <template v-slot:activator="{ on, attrs }">
                ...
                <div class="sigin-day-light">
                    ...
                    <v-btn small class="day-light" depressed @click="dark =! dark">
                ...
                megaMenu:[
                    ...
                    },
                    {
                        ...
                        subMenu:[
                            ...
                            { icon:'/assets/icons/mega-menu/gift-card-app.svg', title:'پیفت مارت اپلیکیشن',
                                subChild:[
